...
function inner_showPhiBaseGraph(serverURL, interactionType, interactionIRI,
	...
	//quitar %3C y %3E de interactionIRI
	var interactionIRI_clear = interactionIRI.replace("%3C", "");
	interactionIRI_clear = interactionIRI_clear.replace("%3E", "");
	interactionIRI_clear = interactionIRI.replace("<", "");
	interactionIRI_clear = interactionIRI_clear.replace(">", "");
	// Url de llamado
	var callUrl = serverURL + "?interaction=" + interactionIRI_clear;
	//var callUrl = serverURL + "?interaction=" + interactionIRI; //+ "&class_type="	+ elementIRI;
